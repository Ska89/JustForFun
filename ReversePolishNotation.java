 ...
 * Most of us get used to using infix math notation while writing arithmetic expressions, like this:
 ...
 2 * 4 + 9 / 3
 Meanwhile in programming the concept of postfix notation is often exploited. This form (often called also Reverse
 Polish Notation) was used in many programmable calculators and in some languages (e.g. Forth) to simplify processing.
 Moreover one of the popular ways of parsing and executing of infix notation is via conversion to postfix one.
 ...
 It is also easy to extend these rules for using unary operations - for them only one value should be popped from the
 stack instead of two. So for example formula for root of quadratic equation:
...
public class ReversePolishNotation {
    public static void main(String[] args) {
        ...
        printResult(calculate(sc.nextLine()));
        sc.close();
    }
