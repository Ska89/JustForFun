 ...
 * Answer should contains card names in form Rank-of-Suit, e.g. Queen-of-Spades, 2-of-Clubs separated with spaces.
 * Use the names as given above.
 * Example:
 * input data:
 * 5
 * 25 32 51 20 6
...
public class CardNames {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < count; i++) {
            int[] result = getSuitAndRankPosition(sc.nextInt());
            sb.append(String.format("%s-of-%s", RANKS[result[1]], SUITS[result[0]]));
    ...
    private static int[] getSuitAndRankPosition(int value) {
        return new int[]{value / 13, value % 13};
    }
