 ...
 *
 * Here is the classical programming puzzle though it came from ancient times when there are no computers at all.
 * We can see that practicing math and logic can sometimes save one's life!
...
public class JosephusProblem {
    public static void main(String[] args) throws Exception {
        ...
        printResult(calculateJosephus(sc.nextInt(), sc.nextInt()));
        sc.close();
    }

    private static int calculateJosephus(int n, int m) {
        int res = 0;
